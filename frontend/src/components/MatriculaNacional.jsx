    ...
    <div className="tbl-page">
      <div className="tbl-topbar">
        <div className="tbl-title-area">
          <h2>📊 Matrícula Nacional 2024-2025</h2>
        ...
        <div className="tbl-filters">
          ...
          <button className="grafica-link-btn" onClick={() => navigate('/graficas/matricula-nacional')}>📊 Ver gráfica</button>
          <button className="grafica-link-btn grafica-link-btn--secundario" onClick={() => navigate('/graficas/matricula-genero')}>👥 Ver género</button>
          <button className="grafica-link-btn grafica-link-btn--secundario" onClick={() => navigate('/graficas/ranking-estados')}>🏅 Ranking</button>
        </div>
      </div>
...
export default MatriculaNacional;
